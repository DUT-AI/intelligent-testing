...
class NeuralCATEngineOptimized(nn.Module):
    ...
    and llm_misconceptions tables. Supports hybrid calibration when num_questions is provided.
    """
    ...
    def __init__(
        ...
        self.d_x = (
            d_embedding  # We keep output of fusion at d_embedding size (e.g. 1024)
        )
        self.fusion = QuestionFeatureFusion(
    ...
    def forward(
        ...
        Returns:
            ...
            se: Standard Error of student ability theta, shape (B, T)
        """
        ...
        # 5. Block 4: Decoding Head & Ability Update (returns shift-aligned theta sequence and log_var)
